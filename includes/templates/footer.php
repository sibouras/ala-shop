      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="payment-pic">
            <img src="layout/img/payment-method.png" alt="" />
          </div>
        </div>
      </div>
    </div>
...
<script src="layout/js/jquery.zoom.min.js"></script>
<script src="layout/js/jquery.dd.min.js"></script>
